...
<head>
	...
	<meta name="keywords" content="web sites, diseño web de calidad, diseño web culiacan, diseño web uruapan, seniorastudio, seniorastudio.com">
			...
			<div class="container">
				...
				<div class="pricing-tables">
					...
					<div class="plan">
		                ...
		                <div class="price">
		                    <span class="price-main"><span class="symbol">$</span>1,500</span>
		            ...
		            <div class="plan">
		                <div class="head">
		                    <h3>Básico</h3> </div>
		                <div class="price">
		                    <span class="price-main"><span class="symbol">$</span>1,900</span>
		                    <!-- <span class="price-additional">per month</span>-->
		                </div>
		                    <ul class="item-list">
		            ...
		            <div class="plan recommended">
		                ...
		                <div class="price">
		                     <span class="price-main"><span class="symbol">$</span>2,500</span>
		                    <!-- <span class="price-additional">per month</span>-->
		                </div>
		                    <ul class="item-list">
		                    ...
		                    <h3>Servicios Adicionales</h3> 
		                	 ...
		                	 <ul class="item-list"> 
		                       ...
		                       <li>Soporte técnico </li>
		                        <li>Aumento de tráfico en la web. </li>
		                    </ul>   
		                <!-- <button type="button" class="btn btn-default rounded">Saber más</button>
		                <span class="price-additional">per month</span>-->
		            </div>
